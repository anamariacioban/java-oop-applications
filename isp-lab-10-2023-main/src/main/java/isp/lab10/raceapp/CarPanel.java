...
class CarPanel extends JPanel {
    ...
    private Map<String, Long> carFinishTimes = new HashMap<>();
    ...
    public synchronized void carFinished(String carName, long raceDuration) {
        carFinishTimes.put(carName, raceDuration);
        System.out.println(carName + " finished in " + raceDuration + " ms");
