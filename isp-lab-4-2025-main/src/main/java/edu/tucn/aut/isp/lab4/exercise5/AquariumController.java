...
public class AquariumController {
    ...
    public AquariumController(String manufacturer, String model, LocalTime currentTime, LocalTime feedingTime, FishFeeder feeder,TemperatureSensor temperatureSensor, LevelSensor levelSensor, Actuator temperatureActuator, Actuator waterLevelActuator, float presetTemperature, int presetLevel ) {
