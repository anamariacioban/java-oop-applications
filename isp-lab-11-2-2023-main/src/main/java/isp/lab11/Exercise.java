...
public class Exercise {
    ...
    public static void displayMenu(ATCClass atc) {
        ...
        String aid = null;
            ...
            switch (command) {
                ...
                case "2":
                    ...
                    aid = scanner.nextLine();
                    atc.sendCommand(aid, new ATcCommandClass("take off"));
                    dummyAircraft.start();
                    break;
                case "3":
                    System.out.print("Send land command to aircraft id: ");
                    aid = scanner.nextLine();
                    atc.sendCommand(aid, new ATcCommandClass("land"));
                    dummyAircraft.land();
                    break;
                case "4":
                    atc.showAircrafts();
