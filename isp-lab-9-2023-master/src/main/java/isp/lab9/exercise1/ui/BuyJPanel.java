    ...
    private void initComponents(){
        ...
        buyButton.addActionListener(e -> {
            try {
                ...
                BigDecimal availableCash = mainFrame.getPortfolio().getCash();
                ...
                if (availableCash.compareTo(totalCost) >= 0) {
                    // Update cash
                    mainFrame.getPortfolio().setCash(availableCash.subtract(totalCost));
                    // Update shares
                    mainFrame.getPortfolio().getShares().merge(symbol, quantity, Integer::sum);

                    // Actualizează câmpul cu fonduri disponibile
                ...
                JOptionPane.showMessageDialog(this, "Failed to fetch stock price!", "Error", JOptionPane.ERROR_MESSAGE);
            }
        });
